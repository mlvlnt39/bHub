...
if( ! function_exists( 'sc_pix_promo_box' ) ){
	...
	function sc_pix_promo_box( $attr, $content = null ){
		...
		$output .= '<div class="card w-100 h-1002 bg-'.$overlay_color.'  pix-hover-item '.$rounded_img.' position-relative overflow-hidden text-white '.$class_names.'" '.$el_style.' '.$jarallax.'>
