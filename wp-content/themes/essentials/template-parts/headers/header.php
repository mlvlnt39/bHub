...
if(!empty($header_data->val)):
    if(!empty($header_data->val->header_1)):
        ...
        <header
            id="masthead"
            class="pix-header <?php echo esc_attr($header_sticky); ?> pix-header-desktop d-block pix-header-normal pix-scroll-shadow  header-scroll pix-header-container-area bg-<?php echo esc_attr( $background ); ?>"
